      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-slate-50 via-white to-orange-50">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg leading-8 text-muted-foreground">
            ...
            Gripton Safety offers premium lifting and cargo securing
            hardware engineered for strength, durability and reliable
          ...
          >
            ...
            <div>
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-8">
                ...
                corrosion resistance for demanding cargo securing
                applications.
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="order-1 lg:order-2 bg-white rounded-3xl shadow-lg p-10">
              ...
              <img
                src="/assets/ratchet_hardware.jpg"
                alt="Ratchet Buckle"
                className="w-full h-[420px] object-contain"
              />
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-orange-500">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center text-white">
          ...
          <p className="mt-6 text-lg leading-8 opacity-90">
            ...
            Whether you require forged J Hooks, industrial ratchet buckles,
            or complete cargo securing hardware, Gripton Safety provides
